...
const voiceChannelTitles = document.querySelectorAll('.voice-channel-title')
...
function voiceChannelHandler(e) {
  ...
  you.textContent = 'Weij33t'
  you.insertAdjacentHTML('afterbegin', '<img src="src/discord.png" />&nbsp;')
  voiceChannels.forEach((channel) => {
    if (channel.querySelector('.you')) {
      channel.querySelector('.you').remove()
    }
